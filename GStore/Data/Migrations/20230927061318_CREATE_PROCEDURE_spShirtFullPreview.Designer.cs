...
namespace GStore.Data.Migrations
{
    ...
    [Migration("20230927061318_CREATE_PROCEDURE_spShirtFullPreview")]
    partial class CREATE_PROCEDURE_spShirtFullPreview
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GStore.Models.spColorsForImageUploads", b =>
                {
                    b.Property<string>("ColorCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("spColorsForImageUploads", null, t => t.ExcludeFromMigrations());

                    b.ToView(null);
                });

            modelBuilder.Entity("GStore.Models.spShirtPreviewModel", b =>
                {
                    b.Property<int?>("CategoryId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("spShirtPreviewModel", null, t => t.ExcludeFromMigrations());

                    b.ToView(null);
                });

            modelBuilder.Entity("GStore.Models.spShirtShortWithCategoryName", b =>
                {
                    b.Property<int?>("CategoryId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("spShirtShortWithCategoryName", null, t => t.ExcludeFromMigrations());

                    b.ToView(null);
                });

            modelBuilder.Entity("GStore.Models.spShirtShortWithCategoryNameById", b =>
                {
                    b.Property<int?>("CategoryId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("spShirtShortWithCategoryNameById", null, t => t.ExcludeFromMigrations());
