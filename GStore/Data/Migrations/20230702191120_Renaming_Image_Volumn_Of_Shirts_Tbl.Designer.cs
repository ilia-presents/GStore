...
namespace GStore.Data.Migrations
{
    ...
    [Migration("20230702191120_Renaming_Image_Volumn_Of_Shirts_Tbl")]
    partial class Renaming_Image_Volumn_Of_Shirts_Tbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Level2SetShirt", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");

                    b.Property<int>("Level2SetsId")
                        .HasColumnType("int");

                    b.HasKey("CategoryId", "Level2SetsId");

                    b.HasIndex("Level2SetsId");

                    b.ToTable("Level2SetShirt");
                });
            ...
            modelBuilder.Entity("Level2SetShirt", b =>
                {
                    b.HasOne("GStore.Models.Shirt", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GStore.Models.Level2Set", null)
                        .WithMany()
                        .HasForeignKey("Level2SetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
